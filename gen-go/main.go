...
func main() {
	...
	if *server {
		if err := tutorial.RunServer(transportFactory, protocolFactory, *addr, *secure); err != nil {
			fmt.Println("error running server:", err)
		}
	} else {
		if err := tutorial.RunClient(transportFactory, protocolFactory, *addr, *secure, cfg); err != nil {
